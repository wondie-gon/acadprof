...
<nav id="main-nav" class="navbar navbar-expand-md navbar-dark wonui-navbar" aria-labelledby="main-nav-label">
	...
	<div class="<?php echo esc_attr( $container ); ?>">
		...
		<button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarNavOffcanvas" aria-controls="navbarNavOffcanvas" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'acadprof' ); ?>">
