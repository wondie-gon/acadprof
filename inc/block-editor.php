...
add_action( 'after_setup_theme', 'acadprof_block_editor_setup' );

if ( ! function_exists( 'acadprof_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function acadprof_block_editor_setup() {
		...
		$color_palette = acadprof_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'acadprof_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function acadprof_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'acadprof_theme_editor_color_palette', $color_palette );
	}
}
