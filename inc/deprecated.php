...
if ( ! function_exists( 'acadprof_adjust_body_class' ) ) {
	 ...
	 */
	function acadprof_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'acadprof_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function acadprof_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'acadprof' ),
		__( 'Previous', 'acadprof' ),
		__( 'Next', 'acadprof' ),
		__( 'About:', 'acadprof' ),
		__( 'Profile', 'acadprof' ),
		__( 'Posts by', 'acadprof' ),
		__( 'Permanent Link:', 'acadprof' ),
		__( 'in', 'acadprof' ),
		__( 'Edit', 'acadprof' ),
	);
}
