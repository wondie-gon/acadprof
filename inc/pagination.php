...
if ( ! function_exists( 'acadprof_pagination' ) ) {
	/**
	 ...
	 */
	function acadprof_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'acadprof' ),
				'next_text'          => __( '&raquo;', 'acadprof' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'acadprof' ),
			)
		);
